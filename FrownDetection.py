...
def rapidFrownCascade(src, rectX, rectY, rectW, rectH, histogramMedian):
    """
    ...
    return frownDetected #int(bottomOfLip), topOfLip
...
def mouthFrowning(src, rectX, rectY, rectW, rectH):
    """
    ...
    if deleteFromLeft > rectW/3:
        deleteFromLeft = 0
    smileDetected = rapidFrownCascade(src, rectX+deleteFromLeft, rectY, rectW-deleteFromRight, rectH, histogramMedian)
